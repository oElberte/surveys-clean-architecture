...
void main() {
  ...
  void mockStreams() {
    //Everytime "presenter.*ErrorStream" has a new value the "*ErrorController.stream" is updated with the value.
  ...
  Future<void> loadPage(WidgetTester tester) async {
    ...
    final loginPage = GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(
            name: '/any_route', page: () => Scaffold(body: Text('fake_page'))),
      ],
    );
  ...
  testWidgets('Should present no error if password is valid with empty string',
      (WidgetTester tester) async {
    await loadPage(tester);
